...
#          The program waits for a response from client, then 
#          receives IV and ciphertext from "client.py". 
#          After receiving it, it is decrypted.
#
...
import socket       #Handles the TCP connection
import os           #Generate random bytes (IV)
